...
urlpatterns = [
    ...
    path('activate_comp/<int:comp_pk>/', views.activate_change_comp,
    name='activate_change_comp'),
    path('change_assembly_comp/<int:comp_pk>/', views.change_assembly,
    ...
    path('add_manager/<str:serv_pk>/', views.add_manager,
    name='add_manager'),
    ]
