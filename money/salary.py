...
class Salary:
    ...
    def salary_manager(self, man):
        # ЗП менеджеров включая категорийного
        month, year = self.month, self.year
    ...
    def salary_kurier(self, plan_stavka_=None, no_stavka=True, per_comps=False):
        ...
        if kurier_man:
            ...
            if plan_stavka_:
                ...
                rate_serve['ЗП'] = summa if not no_stavka else summa_bids * tarif
