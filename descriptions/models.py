...
class CPU(models.Model):
    ...
    cpu_i_g_ua = models.CharField(max_length=300, db_index=True, verbose_name='графика_укр')
    cpu_i_g_rus = models.CharField(max_length=300, db_index=True, verbose_name='графика_ру')
    more = models.CharField(null=True, blank=True,max_length=300, db_index=True,
    verbose_name='More')
