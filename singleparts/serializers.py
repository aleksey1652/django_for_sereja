...
class CoolerSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'cool_warr_ru', 'warranty', 'you_vid', 'label', 'creditoff',
...
class CPUSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'cpu_gpu', 'cpu_warr_ua', 'cpu_warr_ru', 'warranty', 'you_vid', 'label',
...
class MBSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'part_mb_warr_ru', 'warranty', 'you_vid', 'label', 'creditoff',
        'cover1', 'cover2', 'cover3', 'part_number_web')
...
class RAMSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'ram_warr_ua', 'ram_warr_ru', 'warranty', 'you_vid', 'label', 'creditoff',
        'cover1', 'cover2', 'cover3', 'part_number_web')
...
class HDDSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'hdd_spd_ph_ru', 'hdd_buf', 'hdd_ff', 'hdd_warr_ua', 'hdd_warr_ru', 'warranty',
...
class PSUSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'psu_ff', 'psu_warr_ua', 'psu_warr_ru', 'warranty', 'you_vid', 'label', 'creditoff',
        'cover1', 'cover2', 'cover3', 'part_number_web')
...
class GPUSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'gpu_warr_ua', 'gpu_warr_ru', 'warranty', 'you_vid', 'label', 'creditoff',
        'cover1', 'cover2', 'cover3', 'part_number_web')
...
class FANSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'fan_warr_ru', 'warranty', 'you_vid', 'label', 'creditoff',
        'cover1', 'cover2', 'cover3', 'part_number_web')
...
class CASESer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'case_sp_m_ru', 'case_warr_ua', 'case_warr_ru', 'warranty', 'you_vid',
...
class SSDSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'ssd_warr_ua', 'ssd_warr_ru', 'warranty', 'you_vid', 'label', 'creditoff',
        'cover1', 'cover2', 'cover3', 'part_number_web')
