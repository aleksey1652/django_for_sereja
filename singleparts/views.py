...
from .models import *
from .forms import RentabilityForm, SinglePackFewForm, AutoForm
# upload_edit_foto APIKEY change_few_things_obj
...
def change_rentability_obj(request, obj_pack, obj_model):
    ...
    'wifi_other': WiFi_OTHER.objects.all(),
    'cables_other': Cables_OTHER.objects.all(),
    'soft_other': Soft_OTHER.objects.all(),
    }
