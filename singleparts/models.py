...
class CPU_OTHER(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '0 Процессоры'
...
class MB_OTHER(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '2 Материнские платы'
...
class HDD_OTHER(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '5 Жесткие диски'
...
class GPU_OTHER(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '1 Видеокарты'
...
class FAN_OTHER(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '8 Вентиляторы'
