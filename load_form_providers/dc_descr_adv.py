...
def newMonitor(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        sc_d=key_in_dict(res[dc_products['Code']], 'Діагональ екрану'),
        sc_r=key_in_dict(res[dc_products['Code']], 'Роздільна здатність екрану'),
        sc_t=key_in_dict(res[dc_products['Code']], 'Тип матриці'),
        sc_ss=key_in_dict(res[dc_products['Code']], "Співвідношення сторін"),
        sc_l=key_in_dict(res[dc_products['Code']], 'Час реакції'),
        sc_v=key_in_dict(res[dc_products['Code']], 'Кут огляду'),
        sc_b=key_in_dict(res[dc_products['Code']], 'Яскравість'),
        sc_s=key_in_dict(res[dc_products['Code']], 'Контрастність'),
        sc_h=key_in_dict(res[dc_products['Code']], 'Частота оновлення'),
        sc_surf_ua=key_in_dict(res[dc_products['Code']], 'Поверхня екрану'),
        sc_d_sub=D_Sub,
        sc_dvi=dvi,
        sc_hdmi=HDMI,
        sc_dp=DisplayPort,
        ...
        sc_warr_ua=key_in_dict(dc_products, 'Warranty'),
        sc_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newKM(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        km_warr_ua=key_in_dict(dc_products, 'Warranty'),
        km_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newKeyboards(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        kb_rgb=kb_rgb_,
        kb_res=kb_res_,
        kb_cab_long=key_in_dict(res[dc_products['Code']], 'Довжина кабеля'),
        kb_leng=key_in_dict(res[dc_products['Code']], 'Розкладка'),
        kb_vol=kb_vol_,
        ...
        kb_col_ua=key_in_dict(res[dc_products['Code']], 'Колір'),
        ...
        kb_warr_ua=key_in_dict(dc_products, 'Warranty'),
        kb_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newMouses(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        mouse_type_connect_ua=key_in_dict(res[dc_products['Code']], "Тип з'єднання"),
        mouse_int='-',
        mouse_sensor_ua=key_in_dict(res[dc_products['Code']], "Тип сенсора"),
        mouse_dpi=key_in_dict(res[dc_products['Code']], "Роздільна здатність сенсора"),
        mouse_numb_buttoms=buttoms,
        mouse_pow_ua=key_in_dict(res[dc_products['Code']], 'Тип живлення'),
        mouse_length_cable=key_in_dict(res[dc_products['Code']], 'Довжина кабелю'),
        mouse_vol=key_in_dict(res[dc_products['Code']], 'Розмір'),
        mouse_weight=key_in_dict(res[dc_products['Code']], 'Вага'),
        mouse_col_ua=key_in_dict(res[dc_products['Code']], 'Колір'),

        mouse_warr_ua=key_in_dict(dc_products, 'Warranty'),
        mouse_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newPads(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        pad_bot_ua=key_in_dict(res[dc_products['Code']], "Матеріал"),
        pad_vol=key_in_dict(res[dc_products['Code']], "Габарити"),
        pad_light=pad_light_,
        pad_col_ua=key_in_dict(res[dc_products['Code']], 'Колір'),

        pad_warr_ua=key_in_dict(dc_products, 'Warranty'),
        pad_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newHeadsets(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        hs_type_connect_ua=key_in_dict(res[dc_products['Code']], 'Тип підключення'),
        hs_sound_range=key_in_dict(res[dc_products['Code']], 'Частотний діапазон'),
        hs_resistance=hs_resistance_,
        hs_purpose_ua=key_in_dict(res[dc_products['Code']], 'Призначення'),
        hs_type_ua=key_in_dict(res[dc_products['Code']], 'Тип навушників'),
        hs_s_type_ua=key_in_dict(res[dc_products['Code']], 'Тип гарнітури'),
        hs_mike_ua=key_in_dict(res[dc_products['Code']], 'Конструкція мікрофону'),
        hs_mike_avail=hs_mike_avail_,
        hs_cable_length=key_in_dict(res[dc_products['Code']], 'Довжина кабелю'),
        hs_interface=hs_interface_,
        hs_usb=hs_usb_,
        hs_usb_type_c=hs_usb_type_c_,
        hs_col_ua=key_in_dict(res[dc_products['Code']], 'Колір'),

        hs_weight=hs_weight_,
        hs_ear_pads_material_ua=key_in_dict(res[dc_products['Code']], 'Матеріал амбушюр'),
        hs_metal_pads_material_ua=key_in_dict(res[dc_products['Code']], 'Матеріал корпусу'),
        hs_time=hs_time_,
        hs_con_type=hs_con_type_,
        hs_water_res=hs_water_res_,
        hs_light=hs_light_,
        hs_pow_ua=key_in_dict(res[dc_products['Code']], 'Живлення'),
        hs_ver = hs_ver_,

        hs_warr_ua=key_in_dict(dc_products, 'Warranty'),
        hs_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newWebcams(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        web_r=key_in_dict(res[dc_products['Code']], "Роздільна здатність"),
        web_pixel=key_in_dict(res[dc_products['Code']],
        "Кількість мегапікселів веб-камери"),
        web_type_sensor=key_in_dict(res[dc_products['Code']], "Тип сенсора"),
        web_mike=web_mike_,

        web_focus=web_focus_,
        web_int=key_in_dict(res[dc_products['Code']], "Інтерфейси"),
        web_angle=key_in_dict(res[dc_products['Code']], "Кут огляду"),
        web_max_f=web_max_f_,
        web_weight=web_weight_,
        web_col_ua=key_in_dict(res[dc_products['Code']], "Колір"),

        web_warr_ua=key_in_dict(dc_products, 'Warranty'),
        web_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newWiFis(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        net_wifi_int=key_in_dict(res[dc_products['Code']], "Інтерфейс підключення"),
        net_wifi_ant_am=net_wifi_ant_am_,
        net_wifi_st=key_in_dict(res[dc_products['Code']], "Стандарти Wi-Fi"),
        net_wifi_ghz=key_in_dict(res[dc_products['Code']], 'Частота роботи Wi-Fi'),
        net_wifi_bt=net_wifi_bt_,

        net_wifi_warr_ua=key_in_dict(dc_products, 'Warranty'),
        net_wifi_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newTables(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        tb_format_ua=key_in_dict(res[dc_products['Code']], 'Форма'),
        tb_led=tb_led_,
        tb_h=tb_h_,
        tb_angle=tb_angle_,
        tb_up=tb_up_,
        ...
        tb_cab=tb_cab_,
        tb_down=tb_down_,
        tb_bot_t_ua=key_in_dict(res[dc_products['Code']], 'Матеріал стільниці'),
        tb_bot_r_ua=tb_bot_r_ua_,
        tb_hight=key_in_dict(res[dc_products['Code']], 'Висота'),
        tb_width=key_in_dict(res[dc_products['Code']], 'Ширина'),
        tb_depth=key_in_dict(res[dc_products['Code']], 'Глибина'),
        tb_weight=key_in_dict(res[dc_products['Code']], 'Вага'),
        tb_col_ua=key_in_dict(res[dc_products['Code']], 'Колір'),

        tb_warr_ua=key_in_dict(dc_products, 'Warranty'),
        tb_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newChairs(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        ch_type_ua=key_in_dict(res[dc_products['Code']], 'Тип'),
        ch_main_ua=key_in_dict(res[dc_products['Code']], 'Основа'),
        ch_chr_ua=key_in_dict(res[dc_products['Code']], 'Хрестовина'),
        ch_mat_ua=key_in_dict(res[dc_products['Code']], 'Оббивка'),
        ch_frame_ua=frame_,
        ch_vol=key_in_dict(res[dc_products['Code']], 'Розміри сидіння'),
        ch_back=key_in_dict(res[dc_products['Code']], 'Розміри спинки'),
        ch_back_angle=key_in_dict(res[dc_products['Code']], 'Кут нахилу спинки'),
        ch_hand=ch_hand_,
        ch_hight=ch_hight_,
        ch_mech_ua=key_in_dict(res[dc_products['Code']], 'Вбудовані механізми'),
        ch_max_weight=key_in_dict(res[dc_products['Code']],
        'Максимально допустиме навантаження'),
        ch_weight=key_in_dict(res[dc_products['Code']], 'Вага'),
        ch_col_ua=key_in_dict(res[dc_products['Code']], 'Колір'),

        ch_warr_ua=key_in_dict(dc_products, 'Warranty'),
        ch_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newCabelsplus(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        cab_con_f=key_in_dict(res[dc_products['Code']], "Роз'єм 1"),
        cab_con_s=key_in_dict(res[dc_products['Code']], "Роз'єм 2"),
        cab_conn_ua=key_in_dict(res[dc_products['Code']], 'Конектори'),
        cab_flat=cab_flat_,
        cab_tissue=cab_tissue_,
        cab_metal=cab_metal_,
        cab_g_type=cab_g_type_,
        cab_ver='-',
        cab_long=key_in_dict(res[dc_products['Code']], 'Довжина кабеля'),
        cab_col_ua=key_in_dict(res[dc_products['Code']], 'Колір'),

        cab_warr_ua=key_in_dict(dc_products, 'Warranty'),
        cab_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
...
def newFilters(dict_category_periphery, dc_products, dict_category_foto):
    ...
    try:
        ...
        price_usd=temp_price,
        vendor=key_in_dict(dc_products, 'Vendor'),
        fi_num=key_in_dict(res[dc_products['Code']], "Кількість розеток"),
        fi_cab_lenght=key_in_dict(res[dc_products['Code']], "Довжина кабеля"),
        fi_u=key_in_dict(res[dc_products['Code']], 'Робоча напруга'),
        fi_max_i=key_in_dict(res[dc_products['Code']], 'Максимальна сила струму'),
        fi_max_pow=key_in_dict(res[dc_products['Code']],
        'Максимальна сумарна потужність навантаження'),
        fi_con=fi_con_,
        fi_bot_ua=key_in_dict(res[dc_products['Code']], 'Матеріал'),
        fi_col_ua=key_in_dict(res[dc_products['Code']], 'Колір'),

        fi_warr_ua=key_in_dict(dc_products, 'Warranty'),
        fi_warr_ru=key_in_dict(dc_products, 'Warranty'),
        cover1=foto_[0],
        cover2=foto_[1],
        cover3=foto_[-1],
        )
