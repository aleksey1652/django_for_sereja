...
python3 manage.py dumpdata --exclude auth.permission --exclude contenttypes > db_.json
  git:
    ...
    git commit -m "120 version of application moved into github"
      #git remote
      #git remote remove django_for_sereja
    git remote add django_for_sereja https://github.com/aleksey1652/django_for_sereja
    git checkout -b master120 #create branch (ветка)
    #git push django_for_sereja master2
    git push --set-upstream https://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@github.com/aleksey1652/django_for_sereja.git master120
  ...
  server:
    ...
    git clone -b master120 --single-branch https://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@github.com/aleksey1652/django_for_sereja.git
