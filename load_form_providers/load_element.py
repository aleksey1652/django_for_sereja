...
python3 manage.py dumpdata --exclude auth.permission --exclude contenttypes > db.json
  git:
    ...
    git push --set-upstream https://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@github.com/aleksey1652/django_for_sereja.git master27
  ...
  server:
    ...
    git clone -b master27 --single-branch https://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@github.com/aleksey1652/django_for_sereja.git
