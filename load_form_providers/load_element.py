...
python3 manage.py dumpdata --exclude auth.permission --exclude contenttypes > db.json
  git:
    ...
    git push --set-upstream https://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@github.com/aleksey1652/django_for_sereja.git master27
  ...
  server:
    ...
    git clone -b master29 --single-branch https://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@github.com/aleksey1652/django_for_sereja.git
