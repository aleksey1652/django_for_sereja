...
python3 manage.py dumpdata --exclude auth.permission --exclude contenttypes > db.json
  git:
    ...
    git commit -m "33 version of application moved into github"
      #git remote
      #git remote remove django_for_sereja
    git remote add django_for_sereja https://github.com/aleksey1652/django_for_sereja
    git checkout -b master33 #create branch (ветка)
    #git push django_for_sereja master2
    git push --set-upstream https://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@github.com/aleksey1652/django_for_sereja.git master33
  ...
  server:
    ...
    git clone -b master33 --single-branch https://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@github.com/aleksey1652/django_for_sereja.git
