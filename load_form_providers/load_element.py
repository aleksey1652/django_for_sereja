...
python3 manage.py dumpdata --exclude auth.permission --exclude contenttypes > db_.json
  git:
    ...
    git commit -m "122 version of application moved into github"
      #git remote
      #git remote remove django_for_sereja
    git remote add django_for_sereja https://github.com/aleksey1652/django_for_sereja
    git checkout -b master122 #create branch (ветка)
    #git push django_for_sereja master2
    git push --set-upstream https://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@github.com/aleksey1652/django_for_sereja.git master122
  ...
  server:
    ...
    git clone -b master122 --single-branch https://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@github.com/aleksey1652/django_for_sereja.git
