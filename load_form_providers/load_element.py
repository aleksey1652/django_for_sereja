...
python3 manage.py dumpdata --exclude auth.permission --exclude contenttypes > db.json
  git:
    ...
    git checkout -b master32 #create branch (ветка)
    #git push django_for_sereja master2
    git push --set-upstream https://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@github.com/aleksey1652/django_for_sereja.git master32
  ...
  server:
    ...
    git clone -b master32 --single-branch https://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@github.com/aleksey1652/django_for_sereja.git
