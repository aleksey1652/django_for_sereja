...
class Parts_full(models.Model):
    ...
    name_parts_main = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Name_parts_main')
...
class Computers(models.Model):
    ...
    perm_conf = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='perm_conf')
    elite_conf = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='elite_conf')
...
class Promotion(models.Model):
    prom = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='promotions')
    english_prom = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='english_prom')
...
class Pc_assembly(models.Model):
    ...
    desc_ru = models.CharField(null=True, blank=True,max_length=500, db_index=True, verbose_name='Description_ru')
    desc_ukr = models.CharField(null=True, blank=True,max_length=500, db_index=True, verbose_name='Description_ukr')
...
class Results(models.Model):
    who = models.CharField(null=True, blank=True,max_length=50, db_index=True, verbose_name='Who')
    who_desc = models.CharField(max_length=500, db_index=True, verbose_name='Who_desc')
    date_ch = models.DateTimeField(auto_now=True)
...
class Cooler(models.Model):
    ...
    depend_to_type = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Depend_to_type')
...
class MB(models.Model):
    ...
    depend_from = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Depend_from')
    depend_from_type = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Depend_from_type')
    is_active = models.BooleanField(default=True)
...
class CASE(models.Model):
    ...
    more = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='More')
    is_active = models.BooleanField(default=True)
    color_parent = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Color_parent', default='')
    color = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Color', default='')
    color_ukr = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Color_ukr', default='')
    color_ru = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Color_ru', default='')
...
class WiFi(models.Model):
    ...
    part_number = models.CharField(max_length=300, db_index=True, verbose_name='Part_number')
    vendor = models.CharField(max_length=300, db_index=True, verbose_name='Vendor')
    r_price = models.CharField(max_length=300, db_index=True, verbose_name='r_price')
    price = models.CharField(max_length=300, db_index=True, verbose_name='Price')
    desc_ukr = models.TextField(db_index=True, verbose_name='Desc_ukr')
    desc_ru = models.TextField(db_index=True, verbose_name='Desc_ru')
