...
class CASE(models.Model):
    ...
    more = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='More')
    is_active = models.BooleanField(default=True)
    color_parent = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Color_parent')
    color = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Color')
    color_ukr = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Color_ukr')
    color_ru = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Color_ru')
    depend_to = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Depend_to')
    depend_to_type = models.CharField(null=True, blank=True,max_length=300, db_index=True, verbose_name='Depend_to_type')
