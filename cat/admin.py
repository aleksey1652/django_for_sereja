...
class ComputersAdmin(admin.ModelAdmin):
    ...
    IntelCPU_ListFilter, 'is_active', 'pc_assembly__kind_assembly'
    )
    ...
    actions = ['change_advanced', 'add_or_clear_filters', 'set_margin', 'set_special_price',
    'edit_parts_pack_admin', 'change_time_assembly', 'change_promotin_for_pack',]
...
class Parts_shortAdmin(admin.ModelAdmin):
    ...
    list_display = (
    'name_parts', 'x_code', 'parts_full_price', 'sklad_view', 'min_price', 'auto',
    'kind', 'itblok_versum_view', 'parts_full_view', 'get_providers',
    'description_view', 'in_comps',
    )
    #exclude = ('computer_shorts',)
    list_filter = ('kind', 'kind2', 'auto', 'in_comps',) # 'hand',Parts_short_x_code_ListFilter
