...
class ComputersAdmin(admin.ModelAdmin):
    ...
    class Media:
        js = ('admin/js/comps_paginations.js',)
...
class Parts_fullAdmin(admin.ModelAdmin):
    ...
    'availability_parts', 'get_short', 'get_providers', 'remainder',)
