...
class Sheed_element:
    ...
    list_index = ['Name', 'Partnumber', 'Availability', 'Price', 'Url', 'Category']
    Dict_partner = {'itlink': ('Meas', 'Article', 'Availability', 'Price', 'Url','Meas'),
                    'erc': ('gname', 'code', 'swh', 'sprice', 'url', 'swh'),
                    'dc': ('Name', 'Article', 'Availability', 'PriceUSD', 'Url', 'CategoryID'),
                    'asbis': ('DESCRIPTION', 'WIC', 'AVAIL', 'MY_PRICE', 'Url', 'GROUP_NAME'),
                    'mti': ('prodname', 'partnum', 'store', 'price_uah_order', 'url', 'productgroup_id'),
                    'brain': ('Name', 'Article', 'Available', 'PriceUSD', 'URL', 'Group'),
                    'elko': ('productName', 'manufacturerCode', 'stockQuantity', 'price', 'httpDescription', 'catalog'),
                    'edg': ('Name', 'Code', 'StockName', 'Price', 'Url', 'Subcategory'),
