...
class NBSer(serializers.ModelSerializer):
    ...
    vendor = serializers.CharField(source='nb_vendor')

    class Meta:
        model = NB
        fields = ('name', 'category_ru', 'category_ua', 'part_number',
        'price_rent', 'pay_num', 'provider', 'vendor', 'hotline', 'delivery',
        'nb_seria', 'nb_sc_d', 'nb_cpu_vendor', 'nb_cpu_model', 'nb_cpu_f',
        'nb_ram_v', 'nb_gpu_model', 'nb_os', 'nb_ssd',
        'nb_warr_ua', 'nb_warr_rus',
...
class KMSer(serializers.ModelSerializer):
    ...
    class Meta:
        model = KM
        fields = ('name', 'category_ru', 'category_ua', 'part_number',
        'price_rent', 'pay_num', 'provider', 'hotline', 'delivery',
...
class MousesSer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Mouses
        fields = ('name', 'category_ru', 'category_ua', 'part_number',
        'price_rent', 'pay_num', 'provider', 'hotline', 'delivery', 'vendor',
...
class AcousticsSer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'part_number', 'price_rent', 'pay_num', 'provider', 'hotline', 'delivery',
