...
urlpatterns = [
    ...
    path('change_discount/<str:obj_pack>-<str:obj_model>/', views.change_discount,
    ...
    path('change_is_active_tech/<str:obj_pack>-<str:obj_model>/',
    views.change_is_active_tech, name='change_is_active_tech'),
