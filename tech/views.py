...
from .models import *
from singleparts.forms import *

def change_discount(request, obj_pack, obj_model):
    # массовая замена для discount
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            discount_ = form.cleaned_data['discount']
            ...
            messages.success(
            request,
            f"In {count_objs} {obj_model} was update : {discount_}")
