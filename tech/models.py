...
class KM(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Комплекти_клавіатура_мишка'
...
class Accessories(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Аксесуари для ПК'
...
class Filters(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Фiльтри сетьовi'
...
class Others(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Унiверсальне_рiзне'
