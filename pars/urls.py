...
urlpatterns = [
    ...
    path('distrib_comps_promotin/', views.versum_api_comps_promotin.as_view(), name='comps_promotin'),
    path('desk/<str:series>-<str:lang>', views.get_kind_assembly_desc, name='get_kind_assembly_desc'),
]
